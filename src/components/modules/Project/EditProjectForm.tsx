...
import { updateProject } from "@/action/project/updateProject";
...
export default function EditProjectForm({ project }: EditProjectFormProps) {
  const [isFeatured, setIsFeatured] = useState(project?.featured ? "true" : "false");
  ...
  useEffect(() => {
    if (project) {
      ...
      setIsFeatured(project.featured ? "true" : "false");
    }
  }, [project]);
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <LexicalEditor name="description" value={content} onChange={setContent} />
        {/* Hidden input to ensure description is submitted */}
      ...
      <button
        type="submit"
        className="w-full bg-green-600 text-white font-medium py-3 rounded-md hover:bg-green-700 transition-colors focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
      >
        Update Project
      </button>
    </Form>
